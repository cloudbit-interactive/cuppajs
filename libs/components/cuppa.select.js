...
export class CuppaSelect extends CuppaComponent {
	...
	static get observedAttributes() { return ['placeholder', 'type', 'select-class', 'name', 'selected', 'open', 'dropdown-style', 'empty-option-label', 'search-enabled', 'show-arrow'] }
