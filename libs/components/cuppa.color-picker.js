...
export const transparentImage = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAOdEVYdFNvZnR3YXJlAEZpZ21hnrGWYwAAADBJREFUeAHFjLENADAMwkiP4f934Jm0M1OVJR4tyyWpEZBMhYNPFsPqR0rb8+NieAFaiAqZKw8UKgAAAABJRU5ErkJggg=="
	...
	render() {
		...
		return html`
            <div
                ref="pickerButton"
                class="picker-button"
                style="${this.value? `background-color: ${this.value}` : `background-image: url(${transparentImage})`}"
                @click=${this.show}
            ></div>
                    ...
                    <div class="picker-area">
                        <div class="color-picker">
                            <input
                                ...
                                @click=${e => {
                                    if (!this.nativeColorPickerFocus) {
                                        this.nativeColorPickerFocus = true;
                                    } else {
                                        e.stopPropagation();
                                        e.preventDefault();
                                        this.nativeColorPickerFocus = false;
                                        e.target.blur();
                                    }
                                }}
                                @blur=${e => {
