...
export class CuppaAlert extends CuppaComponent {
	static attributes = ["data-title", "message", "accept-text", "cancel-text", "backdrop-enabled", "input-text", "placeholder", "class-modal", "style-modal", "dialog-class", "dialog-style", 'force-show'];
	dataTitle = "Message";
	...
	render() {
		return html`
            <dialog ref="dialog" style="${this.dialogStyle}" class="${this.dialogClass}">
                <div ref="content" class=${`content ${this.classModal}`} style="${this.styleModal}" >
                    ${!this.dataTitle ? '' : html`
