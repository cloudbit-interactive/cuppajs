...
export class CuppaDate extends CuppaComponent {
	...
	static attributes = ['value', 'min-year', 'max-year', 'show-year', 'show-month', 'show-day', 'month-type'];
	static observables = ['value', 'minYear', 'maxYear', 'showYear', 'showMonth', 'showDay', 'monthType'];
	currentDate = new Date();
	value;
	minYear = this.currentDate.getFullYear()-50
	maxYear = this.currentDate.getFullYear()+50;
	showYear = true;
	showMonth = true;
	monthType = CuppaDate.monthTypes.SHORT_NAME;
	showDay = true;
	callback;
