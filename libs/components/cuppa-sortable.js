...
export class CuppaSortable extends CuppaComponent {
	static attributes = ['handle', 'on-drag-class', 'drag-opacity', 'return-value', 'value-key', 'order-key'];
	handle;
...
cuppa.sortable = (
	...
	currentElement.ondragstart = (e)=>{
		...
		currentElement.style.opacity = dragOpacity;
	...
	currentElement.ondragend = (e)=>{
		...
		cuppa.removeClass(sortableClass, onDragClass);
	...
	currentElement.ondragenter = (e)=>{
		...
		currentElement.classList.add(onDragClass);
		if(enterCallback) enterCallback();
	};
	
	currentElement.ondragleave = (e)=>{
		currentElement.classList.remove(onDragClass);
