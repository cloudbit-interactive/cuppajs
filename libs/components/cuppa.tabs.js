...
export class CuppaTab extends CuppaComponent {
    ...
    render(){
        return /*html*/`
            <style>
                cuppa-tab{ transition:0.3s; transition-property:background-color, color; display:flex; justify-content:center; align-items:center; color:#B1B1B1; padding:10px 10px; font-size:11px; cursor:pointer; }
