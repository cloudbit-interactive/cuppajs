...
export class CuppaShortcut extends CuppaComponent {
	static ICONS = {COMMAND:'⌘', SHIFT:'⇧', OPTION:'⌥', CONTROL:'Ctrl', ALT:'Alt'};
	static attributes = ['keys', 'hide', 'label', 'disabled'];
	...
	detect(e){
		...
		if(!valid) return;
		this.dispatchEvent(new CustomEvent("input", {detail:keys}));
	}
...
document.defaultView.CuppaShortcutMin = CuppaShortcut;
