...
export class CuppaComponent extends HTMLElement{refs={};shadow=null;renderedCount=0;_template;_callbacks=[];constructor(){super(),this.getPropertiesCallbacks(),this.binAll=this.binAll.bind(this),this.connectedCallback=this.connectedCallback.bind(this),this.forceRender=this.forceRender.bind(this),this.disconnectedCallback=this.disconnectedCallback.bind(this),this.observables=this.observables.bind(this),this.applyObservables=this.applyObservables.bind(this),this.applyObservables(),this.binAll(this)}static get observedAttributes(){return this.attributes||[]}attributeChangedCallback(e,t,s){t!==s&&("false"===s&&(s=!1),"true"===s&&(s=!0),this[camelize(e)]=s)}applyObservables(){this.constructor.observables&&setTimeout((()=>{let e={};for(let t=0;t<this.constructor.observables.length;t++){let s=this.constructor.observables[t];e[s]=this[s]}this.observables(e),this.forceRender()}),0)}getPropertiesCallbacks(){let e=Object.entries(this);for(let t=0;t<e.length;t++){let[s,i]=e[t];-1===["refs","shadow","renderedCount","_template","_callbacks"].indexOf(s)&&this._callbacks.push({key:s,value:i})}}reSetPropertiesCallbacks(){for(let e=0;e<this._callbacks.length;e++){let{key:t,value:s}=this._callbacks[e];this[t]=s}}connectedCallback(){this.reSetPropertiesCallbacks(),this.shadow&&this.attachShadow({mode:this.shadow}),this.forceRender(null,!1),this.rendered&&this.rendered(this.renderedCount,this),setTimeout((()=>{this.applyStylesAfterRender(),this.mounted&&this.mounted(this)}),0)}applyStylesAfterRender(){const e=this.getAttribute("style-after-render");if(e)for(const t of e.split(";")){const[e,s]=t.split(":");e&&s&&(this.style[e.trim()]=s.trim())}}disconnectedCallback(){this.unmounted&&this.unmounted(this)}setVariables(e){Object.entries(e).map((([e,t])=>{this[`${e}`]=t})),this.forceRender()}forceRender(e=null,t=!0){this._template||(this._template=()=>this.render()),this.shadowRoot?render(this._template(),this.shadowRoot):render(this._template(),this),this.processRefs(this,this.refs,"ref"),e&&e(),this.renderedCount++,this.firstRendered&&1===this.renderedCount&&this.firstRendered(this.renderedCount,this),this.rendered&&t&&this.rendered(this.renderedCount,this)}processRefs(e,t,s){s||(s="id");let i={},r=Array.from(e.querySelectorAll(`[${s}]`));for(let e=0;e<r.length;e++)t?t[r[e].getAttribute(s)]=r[e]:i[r[e].getAttribute(s)]=r[e];return t?t.rootHtml=e:i.rootHtml=e,i}binAll(e,t){let s=Object.getOwnPropertyNames(Object.getPrototypeOf(e));t&&(s=Object.keys(e));for(let t=0;t<s.length;t++)"constructor"!==s[t]&&"function"==typeof e[s[t]]&&(e[s[t]]=e[s[t]].bind(e))}bind(e){let t=Object.getOwnPropertyNames(Object.getPrototypeOf(e));for(let s=0;s<t.length;s++)if("function"==typeof e[t[s]]){if(this[t[s]])continue;this[t[s]]=e[t[s]].bind(e)}}observables(e,t){let s,i=this;if(e){if(!Array.isArray(e))return Object.keys(e).map(((r,l)=>{l||(s=r);let n=e[r],o="_"+r;i[o]=n,Object.defineProperty(i,r,{set:e=>{i[o]=e,i.forceRender&&i.forceRender(),t&&t()},get:()=>i[o],configurable:!0})})),i[s];e.forEach((e=>{this.observable(e,this[e])}))}}observable(e,t){return setTimeout((()=>{t&&void 0===this[e]||(t=this[e]),this.observables({[e]:t})}),0),t}}export function camelize(e){return(e=(e=(e=(e=(e=String(e)||"").replace(new RegExp("-","g")," ")).replace(new RegExp("_","g")," ")).toLowerCase()).replace(/[^\w\s]/gi,"")).replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(function(e,t){return 0==+e?"":0===t?e.toLowerCase():e.toUpperCase()}))}const t=globalThis,i=t.trustedTypes,s=i?i.createPolicy("lit-html",{createHTML:e=>e}):void 0,e="$lit$",h=`lit$${Math.random().toFixed(9).slice(2)}$`,o="?"+h,n=`<${o}>`,r=document,l=()=>r.createComment(""),c=e=>null===e||"object"!=typeof e&&"function"!=typeof e,a=Array.isArray,u=e=>a(e)||"function"==typeof e?.[Symbol.iterator],d="[ \t\n\f\r]",f=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v=/-->/g,_=/>/g,m=RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),p=/'/g,g=/"/g,$=/^(?:script|style|textarea|title)$/i,y=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),x=y(1),b=y(2),w=y(3),T=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),A=new WeakMap,C=r.createTreeWalker(r,129);function P(e,t){if(!a(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==s?s.createHTML(t):t}const V=(t,s)=>{const i=t.length-1,r=[];let l,o=2===s?"<svg>":3===s?"<math>":"",a=f;for(let s=0;s<i;s++){const i=t[s];let c,d,u=-1,A=0;for(;A<i.length&&(a.lastIndex=A,d=a.exec(i),null!==d);)A=a.lastIndex,a===f?"!--"===d[1]?a=v:void 0!==d[1]?a=_:void 0!==d[2]?($.test(d[2])&&(l=RegExp("</"+d[2],"g")),a=m):void 0!==d[3]&&(a=m):a===m?">"===d[0]?(a=l??f,u=-1):void 0===d[1]?u=-2:(u=a.lastIndex-d[2].length,c=d[1],a=void 0===d[3]?m:'"'===d[3]?g:p):a===g||a===p?a=m:a===v||a===_?a=f:(a=m,l=void 0);const M=a===m&&t[s+1].startsWith("/>")?" ":"";o+=a===f?i+n:u>=0?(r.push(c),i.slice(0,u)+e+i.slice(u)+h+M):i+h+(-2===u?s:M)}return[P(t,o+(t[i]||"<?>")+(2===s?"</svg>":3===s?"</math>":"")),r]};class N{constructor({strings:t,_$litType$:s},r){let n;this.parts=[];let a=0,c=0;const d=t.length-1,p=this.parts,[u,g]=V(t,s);if(this.el=N.createElement(u,r),C.currentNode=this.el.content,2===s||3===s){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(n=C.nextNode())&&p.length<d;){if(1===n.nodeType){if(n.hasAttributes())for(const t of n.getAttributeNames())if(t.endsWith(e)){const e=g[c++],s=n.getAttribute(t).split(h),i=/([.?@])?(.*)/.exec(e);p.push({type:1,index:a,name:i[2],strings:s,ctor:"."===i[1]?H:"?"===i[1]?I:"@"===i[1]?L:k}),n.removeAttribute(t)}else t.startsWith(h)&&(p.push({type:6,index:a}),n.removeAttribute(t));if($.test(n.tagName)){const e=n.textContent.split(h),t=e.length-1;if(t>0){n.textContent=i?i.emptyScript:"";for(let s=0;s<t;s++)n.append(e[s],l()),C.nextNode(),p.push({type:2,index:++a});n.append(e[t],l())}}}else if(8===n.nodeType)if(n.data===o)p.push({type:2,index:a});else{let e=-1;for(;-1!==(e=n.data.indexOf(h,e+1));)p.push({type:7,index:a}),e+=h.length-1}a++}}static createElement(e,t){const s=r.createElement("template");return s.innerHTML=e,s}}function S(e,t,s=e,i){if(t===T)return t;let r=void 0!==i?s._$Co?.[i]:s._$Cl;const l=c(t)?void 0:t._$litDirective$;return r?.constructor!==l&&(r?._$AO?.(!1),void 0===l?r=void 0:(r=new l(e),r._$AT(e,s,i)),void 0!==i?(s._$Co??=[])[i]=r:s._$Cl=r),void 0!==r&&(t=S(e,r._$AS(e,t.values),r,i)),t}class M{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,i=(e?.creationScope??r).importNode(t,!0);C.currentNode=i;let l=C.nextNode(),n=0,o=0,a=s[0];for(;void 0!==a;){if(n===a.index){let t;2===a.type?t=new R(l,l.nextSibling,this,e):1===a.type?t=new a.ctor(l,a.name,a.strings,this,e):6===a.type&&(t=new z(l,this,e)),this._$AV.push(t),a=s[++o]}n!==a?.index&&(l=C.nextNode(),n++)}return C.currentNode=r,i}p(e){let t=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class R{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),c(e)?e===E||null==e||""===e?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==T&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):u(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&c(this._$AH)?this._$AA.nextSibling.data=e:this.T(r.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:s}=e,i="number"==typeof s?this._$AC(e):(void 0===s.el&&(s.el=N.createElement(P(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(t);else{const e=new M(i,this),s=e.u(this.options);e.p(t),this.T(s),this._$AH=e}}_$AC(e){let t=A.get(e.strings);return void 0===t&&A.set(e.strings,t=new N(e)),t}k(e){a(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,i=0;for(const r of e)i===t.length?t.push(s=new R(this.O(l()),this.O(l()),this,this.options)):s=t[i],s._$AI(r),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class k{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,r){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=E}_$AI(e,t=this,s,i){const r=this.strings;let l=!1;if(void 0===r)e=S(this,e,t,0),l=!c(e)||e!==this._$AH&&e!==T,l&&(this._$AH=e);else{const i=e;let n,o;for(e=r[0],n=0;n<r.length-1;n++)o=S(this,i[s+n],t,n),o===T&&(o=this._$AH[n]),l||=!c(o)||o!==this._$AH[n],o===E?e=E:e!==E&&(e+=(o??"")+r[n+1]),this._$AH[n]=o}l&&!i&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class H extends k{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}}class I extends k{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}}class L extends k{constructor(e,t,s,i,r){super(e,t,s,i,r),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??E)===T)return;const s=this._$AH,i=e===E&&s!==E||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==E&&(s===E||i);i&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class z{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}}const Z={M:e,P:h,A:o,C:1,L:V,R:M,D:u,V:S,I:R,H:k,N:I,U:L,B:H,F:z},j=t.litHtmlPolyfillSupport;j?.(N,R),(t.litHtmlVersions??=[]).push("3.3.1");const B=(e,t,s)=>{const i=s?.renderBefore??t;let r=i._$litPart$;if(void 0===r){const e=s?.renderBefore??null;i._$litPart$=r=new R(t.insertBefore(l(),e),e,void 0,s??{})}return r._$AI(e),r},directive_t_CHILD=2,directive_e=e=>(...t)=>({_$litDirective$:e,values:t});class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const{I:directive_helpers_t}=Z,directive_helpers_r=()=>document.createComment(""),directive_helpers_s=(e,t,s)=>{const i=e._$AA.parentNode,r=void 0===t?e._$AB:t._$AA;if(void 0===s){const t=i.insertBefore(directive_helpers_r(),r),l=i.insertBefore(directive_helpers_r(),r);s=new directive_helpers_t(t,l,e,e.options)}else{const t=s._$AB.nextSibling,l=s._$AM,n=l!==e;if(n){let t;s._$AQ?.(e),s._$AM=e,void 0!==s._$AP&&(t=e._$AU)!==l._$AU&&s._$AP(t)}if(t!==r||n){let e=s._$AA;for(;e!==t;){const t=e.nextSibling;i.insertBefore(e,r),e=t}}}return s},directive_helpers_v=(e,t,s=e)=>(e._$AI(t,s),e),directive_helpers_u={},directive_helpers_M=e=>{e._$AR(),e._$AA.remove()},repeat_u=(e,t,s)=>{const i=new Map;for(let r=t;r<=s;r++)i.set(e[r],r);return i},repeat_c=directive_e(class extends directive_i{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,s){let i;void 0===s?s=t:void 0!==t&&(i=t);const r=[],l=[];let n=0;for(const t of e)r[n]=i?i(t,n):n,l[n]=s(t,n),n++;return{values:l,keys:r}}render(e,t,s){return this.dt(e,t,s).values}update(e,[t,s,i]){const r=(e=>e._$AH)(e),{values:l,keys:n}=this.dt(t,s,i);if(!Array.isArray(r))return this.ut=n,l;const o=this.ut??=[],a=[];let h,c,d=0,p=r.length-1,u=0,g=l.length-1;for(;d<=p&&u<=g;)if(null===r[d])d++;else if(null===r[p])p--;else if(o[d]===n[u])a[u]=directive_helpers_v(r[d],l[u]),d++,u++;else if(o[p]===n[g])a[g]=directive_helpers_v(r[p],l[g]),p--,g--;else if(o[d]===n[g])a[g]=directive_helpers_v(r[d],l[g]),directive_helpers_s(e,a[g+1],r[d]),d++,g--;else if(o[p]===n[u])a[u]=directive_helpers_v(r[p],l[u]),directive_helpers_s(e,r[d],r[p]),p--,u++;else if(void 0===h&&(h=repeat_u(n,u,g),c=repeat_u(o,d,p)),h.has(o[d]))if(h.has(o[p])){const t=c.get(n[u]),s=void 0!==t?r[t]:null;if(null===s){const t=directive_helpers_s(e,r[d]);directive_helpers_v(t,l[u]),a[u]=t}else a[u]=directive_helpers_v(s,l[u]),directive_helpers_s(e,r[d],s),r[t]=null;u++}else directive_helpers_M(r[p]),p--;else directive_helpers_M(r[d]),d++;for(;u<=g;){const t=directive_helpers_s(e,a[g+1]);directive_helpers_v(t,l[u]),a[u++]=t}for(;d<=p;){const e=r[d++];null!==e&&directive_helpers_M(e)}return this.ut=n,((e,t=directive_helpers_u)=>{e._$AH=t})(e,a),T}});class unsafe_html_e extends directive_i{constructor(e){if(super(e),this.it=E,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===E||null==e)return this._t=void 0,this.it=e;if(e===T)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}unsafe_html_e.directiveName="unsafeHTML",unsafe_html_e.resultType=1;const unsafe_html_o=directive_e(unsafe_html_e);export{unsafe_html_e as UnsafeHTMLDirective,Z as _$LH,x as html,w as mathml,T as noChange,E as nothing,B as render,repeat_c as repeat,b as svg,unsafe_html_o as unsafeHTML};let $LH=unsafe_html_e,html=x,noChange=T,nothing=A,render=B,repeat=repeat_c,svg=b,unsafeHTML=unsafe_html_o;export const CuppaSelectType={SINGLE:"SINGLE",MULTIPLE:"MULTIPLE"};export let arrowImage="data:image/svg+xml;base64,";export let selectedImage="data:image/svg+xml;base64,";export class CuppaSelect extends CuppaComponent{static attributes=["placeholder","type","select-class","list-class","name","selected","open","dropdown-style","empty-option-label","search-enabled","show-arrow","select-style","auto-close","value-column","label-column","label-separator","label-auto-format","multiple-label-separator","search-placeholder","maximum-options-showed","maximum-options-exceeded-label"];static observables=["placeholder","type","selectClass","listClass","name","selected","open","valueColumn","labelColumn","labelSeparator","labelAutoFormat","multipleLabelSeparator","name","emptyOptionLabel","options","search","open","dropdownStyle","searchEnabled","showArrow","selectStyle","autoClose","searchPlaceholder","maximumOptionsShowed","maximumOptionsExceededLabel"];placeholder="Select";type=CuppaSelectType.SINGLE;callback=null;closeCallback=null;selectClass="";listClass="";valueColumn="id";labelColumn="name";labelSeparator=", ";labelAutoFormat=!1;multipleLabelSeparator=" - ";name="";options=[];selected;searchEnabled=!0;search="";searchPlaceholder="Search...";open=!1;dropdownStyle="";emptyOptionLabel="Select...";showArrow=!0;selectStyle="";autoClose=!0;maximumOptionsShowed=3;maximumOptionsExceededLabel="...";mounted(){document.addEventListener("keyup",(e=>{"escape"===String(e?.code).toLowerCase()&&(e.preventDefault(),e.stopPropagation(),this.close())})),document.addEventListener("click",(e=>{this.open&&(this.close(),this.open=!1)})),this.addEventListener("click",(e=>{e.stopPropagation(),e.preventDefault()})),this.refs?.select&&this.refs?.select.addEventListener("keypress",(e=>{"space"===String(e?.code).toLowerCase()&&(e.preventDefault(),e.stopPropagation(),this.open?this.close():this.open=!0)})),this.refs?.search&&this.refs?.search.addEventListener("keypress",(e=>{if("enter"===String(e?.code).toLowerCase()){e.preventDefault(),e.stopPropagation(),this.open?this.close():this.open=!0;const t=(this.options||[]).filter((e=>-1!==String(e[this.labelColumn]).toLowerCase().indexOf(this.search.toLowerCase())));if(!t?.length)return;const s=t[0];let i="object"==typeof s?s[this.valueColumn]:s;this.selectValue(i)}}))}selectValue(e,{close:t=!0}={}){if(this.type===CuppaSelectType.MULTIPLE){const t=this.selected?String(this.selected).split(",").map((e=>e.trim())):[];if(t.includes(String(e))){const s=t.filter((t=>t!==String(e)));this.selected=s.filter((e=>e)).join(",")}else t.push(String(e)),this.selected=t.filter((e=>e)).join(",")}else this.selected=e;this.dispatchEvent(new CustomEvent("change",{detail:this.selected})),this.callback&&this.callback(this.selected),t&&this.autoClose&&this.close()}getSelectedLabel(){if(!this.selected)return"";const e=String(this.selected).split(",").map((e=>e.trim())).filter((e=>e))||[],t=[];for(const[s,i]of e.entries()){let r=this.options.filter((e=>e[this.valueColumn]==i))[0],l=r;if("object"==typeof r&&(l=this.labelColumn.split(",").map((e=>r[e.trim()])),l=l.join(this.multipleLabelSeparator)),l&&(l=String(l).replaceAll("_"," "),t.push(l),s+1>=this.maximumOptionsShowed)){e.length>this.maximumOptionsShowed&&t.push(this.maximumOptionsExceededLabel);break}}return t.join(this.labelSeparator)}rendered(){this.open&&this.refs?.search&&this.refs?.search?.focus()}getOptions(){return(this.options||[]).filter((e=>{let t=e;return"object"==typeof e&&(t=this.labelColumn.split(",").map((t=>e[t.trim()])),t=t.join(this.multipleLabelSeparator)),-1!==String(t).toLowerCase().indexOf(this.search.toLowerCase())}))}close(){this.open&&(this.dispatchEvent(new CustomEvent("close",{detail:this.selected})),this.closeCallback&&this.closeCallback(this.selected)),this.open=!1}render(){const e=String(this.selected).split(",").map((e=>e.trim())),t=this.getSelectedLabel(),s=this.getOptions();return html`
      ...
      >
        ...
        `:""}
        <div class="list" >
          ${s.map((t=>{let s="object"==typeof t?t[this.valueColumn]:t,i=t;"object"==typeof t&&(i=this.labelColumn.split(",").map((e=>t[e.trim()])),i=i.join(this.multipleLabelSeparator)),i=String(i).replaceAll("_"," ");const r=e.includes(String(s));return this.labelAutoFormat&&(i=capitaliseAllWords(i)),html`
              <div
                class="list-item"
                @click=${e=>{this.selectValue(s)}}
              >
                <span>${i}</span>
                ${r?html`<img class="selected-img" src="${selectedImage}" />`:""}
              </div>`}))}
        </div>
      </div>
      <style>
