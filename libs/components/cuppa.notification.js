...
export class CuppaNotification extends CuppaComponent {
	...
	static get observedAttributes() { return ['title', 'message', 'close-text', 'auto-close-time', 'hover-avoid-auto-close', 'leave-enable-auto-close'] }
