    ...
    render(){
        return /*html*/`
            <style>
                ...
                cuppa-select-time[disabled=true] *{ opacity:0.6; pointer-events:none; }
                cuppa-select-time select{ margin:0 0 0 3px; border-radius: 3px; }
                cuppa-select-time select:first-of-type{ margin:0; }
            </style>

            <select onchange="e=>this.hours = parseInt(e.target.value)" class="cuppa-hours ${ this["select-class"] || '' }" >
                ${ this.militaryTime ? (
            ...
            <select onchange="e=>this.minutes = parseInt(e.target.value)" class="cuppa-minutes ${ this["select-class"] || ''}" >
            ...
            ${ !this.showSeconds ? '' : `
                <select onchange="e=>this.seconds = parseInt(e.target.value)" class="cuppa-seconds ${ this["select-class"] || ''}" >
                    ${ this.arrayFromTo(0,59).map(number=>{
                        let numberStr = ('0' + number).slice(-2);
            ...
            ${this.militaryTime ? '' : `
                <select onchange="e=>this.meridiem = e.target.value" class="cuppa-meridiem ${ this["select-class"] || '' }" >
