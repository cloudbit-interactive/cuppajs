...
export class CuppaToast extends Component{
	...
	show(message, opts){
		...
		this.tweens.tween1.set(this.rootRef, {style:{opacity:0, display:"flex"}});
		this.tweens.tween1.to(this.rootRef, {style:{opacity:1}, duration:opts.fadeIn, delay:opts.delay});
		this.tweens.tween1.to(this.rootRef, {duration:opts.fadeOut, style:{opacity:0}}, opts.duration);
		this.tweens.tween1.set(this.rootRef, {style:{display:"none"}});
	}

	render(){
		return(
			<View ref={ref=>this.rootRef=ref} pointerEvents="none" style={[{display:"none", paddingHorizontal:20, opacity:0, position:"absolute", left:0, top:"auto", bottom:20, alignItems:"center", width:"100%", justifyContent:"center", elevation:9999, zIndex:9999, overflow:"hidden"}, this.props.styleWrap]}>
