...
export class CuppaPreviewCode extends CuppaComponent {
	...
	render(){
      ...
      <style>
        ...
        cuppa-preview-code ::-webkit-scrollbar-track { background: transparent; }
        cuppa-preview-code ::-webkit-scrollbar-thumb { background: #666; border-radius: 6px; }
        cuppa-preview-code ::-webkit-scrollbar-thumb:hover { background: #fff; }
