...
export class CuppaPreviewCodeMin extends CuppaComponent {
	...
	static get observedAttributes() { return ['mode', 'ace-theme', 'content', 'preview', 'height', 'preview-height', 'preview-width', 'disabled', 'expandable', 'show-tools-bar' ] }
	...
	render(){
      ...
      <style>
        ...
        .cuppa-preview-code__output{ position: relative; font-family: "Arial", sans-serif; flex:${this.previewWidth != 'auto' ? 'none' : 1}; width: ${this.previewWidth}; background: #23272f; border:0; border-left: 1px solid rgba(0,0,0,1); padding: 10px; }
...
customElements.define('cuppa-preview-code', CuppaPreviewCodeMin);
