...
export class CuppaPreviewCode extends CuppaComponent {
	...
	static get observedAttributes() { return ['mode', 'ace-theme', 'content', 'preview', 'height', 'preview-height', 'preview-width', 'disabled', 'expandable', 'show-tools-bar', 'remove-tabs' ] }
	...
	render(){
      ...
      <style>
        ...
        .cuppa-preview-code__output{ position: relative; font-family: "Arial", sans-serif; flex:${this.previewWidth != 'auto' ? 'none' : 1}; width: ${this.previewWidth}; background: #23272f; color:#fff; border:0; border-left: 1px solid rgba(0,0,0,1); padding: 10px; }
