...
export class CuppaNavBar extends CuppaComponent {
    ...
    static get observedAttributes() {
        return ['status', 'width', 'drag-enabled',
                'backdrop-enabled', 'position', 'disable-content',
    ...
    mounted(){
        ...
        if(this.disableContent && !this.disableContentNodes){
            this.disableContentNodes = document.querySelectorAll(this.disableContent);
        }
    }
    ...
    setDisableContent(value = true){
        if(!this.disableContentNodes) return;
        if(value === true){
            this.disableContentNodes.forEach(item=>{
