...
export class CuppaNavBar extends CuppaComponent {
    ...
    onMouseMove(e){
        if(this.position === CuppaNavBar.LEFT) {
            ...
            let percent = 1 - Math.abs(this.posX/this.width);
            gsap.set(this.refs.contentWrap, {left:this.posX});
            gsap.set(this.refs.blockade, {opacity:percent});
    ...
    onMouseUp(e){
        ...
        this.onmouseup = null;
        let [validSwipe, direction] = this.isValidSwipe(e.movementX, this.swipeConfig.velocityThreshold, e.movementY, this.swipeConfig.directionalOffsetThreshold);
