...
export class CuppaNavBar extends CuppaComponent {
    ...
    mounted(){
        this.addChilds();
        if(this.status == CuppaNavBar.CLOSE){
            this.close(0);
        }
    }
    ...
    open(duration = 0.4){
        ...
        if(this.position === CuppaNavBar.LEFT) {
            ...
            this.tl.to(this.refs.background, {duration, opacity:1, ease: Expo.easeOut}, 0);
    ...
    close(duration = 0.3){
        ...
        if(this.position === CuppaNavBar.LEFT){
            ...
            this.tl.to(this.refs.background, {duration, opacity:0, ease: Expo.easeOut}, 0);
    ...
    render(){
        return html`
            <div ref="background" class="cuppa-navbar_bg"  @click=${()=>this.close()} ></div>
            <div ref="contentWrap" class="navbar_content_wrap">
            </div>
            <style>
                cuppa-navbar{ position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: 100; }
                cuppa-navbar .cuppa-navbar_bg{ background: rgba(0,0,0,0.7); position: absolute; top: 0; bottom: 0; left: 0; right: 0; }
