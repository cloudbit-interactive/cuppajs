...
export class CuppaTooltip extends CuppaComponent {
	...
	render(){
      ...
      <style>
        ...
        cuppa-tooltip .cuppa-tooltip_arrow{ position: absolute; fill:var(--cuppa-tooltip-arrow-color); }
        ...
        cuppa-tooltip.warning .cuppa-tooltip_arrow{ fill:#ff8800; }
        cuppa-tooltip.error{ background-color: #ff4444; color: #fff; }
        cuppa-tooltip.error .cuppa-tooltip_arrow{ fill:#ff4444; }
        cuppa-tooltip.error{ background-color: #ff4444; color: #fff; }
        cuppa-tooltip.error .cuppa-tooltip_arrow{ fill:#ff4444; }
				cuppa-tooltip.progress{ background-color: #1890ff; color: #fff; }
        cuppa-tooltip.progress .cuppa-tooltip_arrow{ fill: #1890ff; }
      	cuppa-tooltip.success{ background-color: #00c851; color:#fff; }
        cuppa-tooltip.success .cuppa-tooltip_arrow{ fill:#00c851; }
      </style>
		`
	}
}
