...
export class CuppaPortal extends CuppaComponent {
	elements = this.observable('elements', {})
	...
	render(){
		let elements = Object.entries(this.elements);
		return html`
...
customElements.define('cuppa-portal', CuppaPortal);
document.defaultView.CuppaPortal = CuppaPortal;
