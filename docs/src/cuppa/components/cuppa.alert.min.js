...
export class CuppaAlert extends CuppaComponent {
    ...
    constructor({title = "", message = "", acceptText = "Accept", cancelText = "", backdropEnabled = false, inputText = null, placeholder = "", callback = null, className = "", topBar = false, closeImage = CuppaAlert.CLOSE_IMAGE} = {}) {
        super();
