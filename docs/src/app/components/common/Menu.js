...
export class Menu extends CuppaComponent {
	...
	mounted() {
		...
		setTimeout(() => {
			this.onRouter(Globals.router.getPath())
		});
	...
	render() {
		return html`
            <get-storage name=${Storages.theme.name} @change=${(e) => {
                this.theme = e.detail;
            }}></get-storage>
            ...
            <nav class="p-x-10 flex-1 o-auto p-b-40 scroll-1">
                <div class="m-y-20">
                    <a class="menu-item ${this.isSelected('cuppa-component')}" href="cuppa-component"
                ...
                <div class="m-y-20">
                    ${Constants.components.map(component => {
                        return html`
                            <a class="menu-item ${this.isSelected(component.href)} ${component.disabled ? 'disabled' : ''}"
                               href="${component.href}" aria-label="${component.label}">${component.label}</a>
                        `
                    })}
                </div>
