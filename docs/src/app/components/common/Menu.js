...
export class Menu extends CuppaComponent {
	...
	render(){
      ...
      <div class="flex j-between a-center p-x-20 p-y-20" style="background: var(--menu-bg-bar)">
        ...
        <div class="flex">
          <a class="button-alpha d-i-children p-x-10 f-18" href="https://www.npmjs.com/package/cuppajs" aria-label="NPM"
             target="_blank">
            <i class="fab fa-npm"></i>
          </a>
          <a class="button-alpha d-i-children p-x-10 f-18" href="https://github.com/cloudbit-interactive/cuppajs"
      ...
      <nav class="p-x-10 flex-1 o-auto p-b-40 scroll-1">
        <div class="m-t-10">
          <a class="menu-item ${this.isSelected('cuppa-component')}" href="cuppa-component" aria-label="Component"><i
            class="fas fa-puzzle-piece "></i> Component</a>
          <a class="menu-item ${this.isSelected('cuppa-router')}" href="cuppa-router" aria-label="Router"><i
            class="fas fa-map-signs"></i> Router</a>
          <a class="menu-item ${this.isSelected('cuppa-storage')}" href="cuppa-storage" aria-label="Storage"><i
            class="fas fa-database"></i> Storage</a>
        </div>

        <h2 class="title-3 m-t-20">Cuppa Components</h2>
        <div class="m-y-20">
          <a class="menu-item ${this.isSelected('cuppa-alert')}" href="cuppa-alert" aria-label="Cuppa Alert">Cuppa
            Alert</a>
          <a class="menu-item ${this.isSelected('cuppa-switch')}" href="cuppa-switch" aria-label="Cuppa Switch">Cuppa
            Switch</a>
          <a class="menu-item ${this.isSelected('cuppa-tabs')}" href="cuppa-tabs" aria-label="Cuppa Tabs">Cuppa Tabs</a>
          <a class="menu-item ${this.isSelected('cuppa-collapsible')}" href="cuppa-collapsible"
             aria-label="Cuppa Collapsible">Cuppa Collapsible</a>
          <a class="menu-item ${this.isSelected('cuppa-drawer')}" href="cuppa-drawer" aria-label="Cuppa Drawer">Cuppa
            Drawer</a>
          <a class="menu-item ${this.isSelected('cuppa-tooltip')}" href="cuppa-tooltip" aria-label="Cuppa Tooltip">Cuppa
            Tooltip</a>
        </div>

        <h2 class="title-3 m-t-20">More</h2>
        <div class=" m-y-10">
          <a class="menu-item ${this.isSelected('performance')}" href="performance" aria-label="Performance"><i
            class="fas fa-tachometer-alt"></i> Component Performance</a>
        </div>
      </nav>
      <style>
	      menu-comp {
