export class Constants {
	...
	static components = [
		...
		{href:'cuppa-select', label:'Select', disabled:true},
		{href:'cuppa-select-time', label:'Select Time', disabled:true},
		{href:'cuppa-shortcut', label:'Shortcut', disabled:true},
		{href:'cuppa-switch', label:'Switch'},
